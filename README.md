...
Explicación: Se necesita de Iluminación por Focos cuando la sesió se realiza en Espacios Interiores para que la calidad de la imagen sea clara y precisa.
...
(Opcional) Si existe un archivo, puedes usarlo:requirements.txt

pip install -r requirements.txt
Ejecutar la Aplicación ¡Lanza la aplicación web de Streamlit!

streamlit run home.py
Automáticamente se abrirá una pestaña en tu navegador predeterminado (generalmente en) mostrando la aplicación.http://localhost:8501
...
Pandas: Biblioteca para manipulación y análisis de datos, ideal para gestionar listas de sesiones de fotos.
Python: Lenguaje de programación principal.
Hecho con ❤️ por :@milagro07
